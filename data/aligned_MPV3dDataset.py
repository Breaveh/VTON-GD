...
class AlignedMPV3dDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        if self.model == 'P' or self.model == 'RDG':
    ...
    def __getitem__(self, index):
        ...
        if 'SGN' or 'GLA' in self.model:
            ...
            #cm = Image.open(os.path.join(self.dataroot, 'aligned', self.datalist, 'cloth-mask', c_name))
        elif 'RDG' in self.model:
            ...
            #cm = Image.open(os.path.join(self.dataroot, 'cloth-mask', c_name))
        ...
        if self.model == 'SGN' or self.model == 'GLA':
        ...
        imfd = ''
        imfd_initial = ''
        if self.model == 'RDG' or self.model == 'P':
