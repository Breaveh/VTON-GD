...
if __name__ == '__main__':
    ...
    parser.add_argument('--depth_root', type=str, default='results/aligned/RDG/test_pairs/final-depth',help='path to the RDG result')
    parser.add_argument('--frgb_root', type=str, default='results/aligned/P/test_pairs/tryon',help='path to the P result (front rgb)')
    # parser.add_argument('--brgb_root', type=str, default='esults/aligned/P/test_pairs/tryon',help='path to the painted back rgb image')
