...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--datamode', type=str, default='aligned',help='dataset mode for SGN [unaligned | aligned]')
        parser.add_argument('--datalist', type=str, default='test_pairs', help='mpv3d data list [train_pairs | test_pairs | test_score]')
        parser.add_argument('--name', type=str, default='SGN', help='name of the experiment. It decides where to store samples and models')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='SGN', help='chooses which model to use. [SGN | RDG | P | GLA]')
