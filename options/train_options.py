...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_epoch_freq', type=int, default=1, help='frequency of showing training results on screen at the end of epoches')
        parser.add_argument('--display_ncols', type=int, default=1, help='if positive, display all images in a single tensorboard panel with certain number of images per row.')
